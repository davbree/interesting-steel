...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dc7e58dcd04f.ngrok.io/pull/608e9a896f463f66845ca0bf
...
To start editing your site, you can use the Sanity interface at https://interesting-steel-e9a89.sanity.studio/.
...
Generated at `2021-05-02T12:27:16.846Z` by Stackbit version `0.3.51`.